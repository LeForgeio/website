...
const examples = [
  ...
  {
    id: "nintex-xtension",
    title: "Workflow Xtension Integration",
    description: "Build a custom Xtension to call LeForge APIs from Nintex workflows with configurable actions and inputs.",
    difficulty: "Intermediate",
    forgehooks: ["LLM Service", "PDF Service", "Data Transform"],
    platform: "Nintex CE",
    href: "/docs/examples/nintex-xtension",
  },
  {
    id: "nintex-forms-plugin",
    title: "Forms Plugin with AI",
    description: "Create a Nintex Forms plugin that auto-fills fields using AI extraction from uploaded documents.",
    difficulty: "Intermediate",
    forgehooks: ["OCR Service", "LLM Service", "Validation Utils"],
    platform: "Nintex CE",
